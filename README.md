...
> note: use `dotnet new list` to get a list of all project templates installed on your machine.
...
### 2. Project Configuration
  ...
  - [Object Relation Mapping](./src/chapters/02_project_configuration/16_orm/Program.cs)
  - [Rate Limiting](./src/chapters/02_project_configuration/17_rate_limits/Program.cs)
  - [Response compression](./src/chapters/02_project_configuration/18_response_compression/Program.cs)
...
### 7. Testing
  ...
  - [Writing integration tests](./src/chapters/07_testing/03_integration_testing/Program.cs)